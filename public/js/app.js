...
/* WEBPACK VAR INJECTION */(function($) {(function () {
	var orderApp = {
		...
		setShippingCost: function setShippingCost(shipping_method) {
			var shipping_cost = void 0;
		...
		setTotalOrderPrice: function setTotalOrderPrice(shipping_cost) {
			var products_price = parseInt($(".products_total_price").text(), 10) * 100;
			var order_total_price = (shipping_cost + products_price) / 100;
		...
		getLastOrder: function getLastOrder() {
			...
			if ($known_address === "true") {
				var last_order = JSON.parse($(".last_order").val());
